  ...
  return (
    <section>
      <div className='max-padd-container mt-8 xl:mt-6'>
        ...
        <div className='max-padd-container flex gap-12 flex-col xl:flex-row bg-white py-6 rounded-2xl'>
          {/* product image */}
          ...
          <div className='flex-[1.5] rounded-2xl px-2'>
            ...
            <div className='flex flex-col gap-4 my-4 mb-5 '>
              <div className='flex gap-2'>
                {[...product.sizes].sort((a, b) => {
                  ...
                  <button onClick={() => setSize(item)} key={i} className={`${item === size ? "bg-tertiary text-white" : "border-slate-900/5"} border-[1.5px] border-tertiary h-8 w-10 bg-primary`}>{item}</button>
                ))}
              </div>
            </div>
            ...
            <div className='mt-2 flex flex-col gap-1'>
              ...
              <p>Eas Returns and Exchanges Within 7 Days</p>
            </div>
          </div>
          <div>
          </div>
