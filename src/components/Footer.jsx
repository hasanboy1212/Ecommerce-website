        ...
        <div className="max-padd-container bg-black text-white py-10 rounded-tr-3xl rounded-tl-3xl">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <p className='text-white mt-5'>Crafted with care and dediction. Bringing quality and style right to your doorstep. Your  satisfation is our promise!</p>
                    <p className='mt-4 text-white'>Copyright 2024 Shoppire. All right reserved.</p>
                </div>
                {/* Quick Links */}
                <div>
                ...
                <div>
                    ...
                    <p className='text-gray-10 mb-2'><BsTelephoneFill className='inline-block mr-2'/>+1 (123) 456-7890</p>
                    <p className='text-gray-10 mb-2'> <BsEnvelopeFill className='inline-block mr-2'/>{""} support@shoppire.com</p>
                    <p className='text-gray-10 mb-2'> <BsGeoAltFill className='inline-block mr-2'/> 123 Shoppire, Suite 100, New York, NY</p>
                </div>
